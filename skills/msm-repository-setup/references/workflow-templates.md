...
레퍼런스 변환: `workflow/evidence/graphify-etl.yaml` (git-tracked, 위 포맷 준수).
`templates/workflow/` 4종(evidence-collection/ontology-construction/validation/
...
`workflow/index.yaml` 은 워크플로를 registry 로 모은다(SPEC §6.2). full-run 검증은
