...
| **Top-Down flow** | structure-first: ontology를 먼저 scaffolding하고 evidence를 채우는 흐름. 도메인 구조가 선명할 때 사용 |
| **Bottom-Up flow** | evidence-first: evidence를 먼저 수집하고 ontology를 귀납 추출하는 흐름. 도메인 구조가 불명확할 때 사용 |
