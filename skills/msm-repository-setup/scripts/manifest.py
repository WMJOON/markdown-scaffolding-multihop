...
BASE_FILES: tuple[Entry, ...] = (
    ...
    Entry("workflow/index.yaml", "file_template", "workflow/index.yaml", "yaml"),
    Entry(
        "workflow/evidence/evidence-collection.yaml",
        "file_template",
        "workflow/evidence/evidence-collection.yaml",
        "yaml",
    ),
    Entry(
        "workflow/ontology/ontology-construction.yaml",
        "file_template",
        "workflow/ontology/ontology-construction.yaml",
        "yaml",
    ),
    Entry(
        "workflow/maintain/validation.yaml",
        "file_template",
        "workflow/maintain/validation.yaml",
        "yaml",
    ),
    Entry(
        "workflow/explorer/search-reason.yaml",
        "file_template",
        "workflow/explorer/search-reason.yaml",
        "yaml",
    ),
