...
v0.10.0의 모든 워크플로우는 `workflow/{category}/*.yaml`로 외부 정의되고, 스킬이 yaml을 소비합니다.
...
| explorer | `workflow/explorer/` | `msm-graph-reasoning` (v0.1x 예정) |
...
변환 레퍼런스: [`workflow/evidence/graphify-etl.yaml`](../../workflow/evidence/graphify-etl.yaml).
