...
| v1-strict | v0.10.0 8개 스킬(`msm-repository-setup`, `msm-evidence`, `msm-ontology`, `msm-maintain`, `msm-graph-reasoning`, `msm-semantic-search`, `msm-harness`, `msm-orchestration`) 모두 존재해야 함 |

본 v0.10.0-β 단계는 compatibility 모드만 검증한다. v1-strict는 `msm-orchestration-v0.10.0-SPEC` 확정 후 활성화 (RS-OI-2).
